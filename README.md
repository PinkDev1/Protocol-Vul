...
| CVE-2020-15802<br>BLURtooth | BLURtooth (the BLUR attacks) exploits the lack of cross-transport key validation, allowing an attacker to bypass Bluetooth Classic and Bluetooth Low Energy security mechanisms. This affects the Cross-Transport Key Derivation (CTKD) component in Bluetooth 4.0 to Bluetooth 5.0 | [CVE-2020-15802](https://kb.cert.org/vuls/id/589825)<br>[BLURtooth Website](https://hexhive.epfl.ch/BLURtooth/) |
| SweynTooth Vulnerabilities<br>Multiple vulnerabilities | Keep in mind, none of the listed vulnerabilities are Exploitable Remotely. Crash from Link Layer Length Overflow (CVE-2019-16336), Crash from Link Layer Length Overflow (CVE-2019-17519), Crash from Truncated L2CAP (CVE-2019-17517), Crash from Silent Length Overflow (CVE-2019-17518), Unexpected Public Key Crash (CVE-2019-17520), Crash from Invalid L2CAP Fragment (CVE-2019-19195), Crash from Key Size Overflow (CVE-2019-19196), Link Layer LLID deadlock (CVE-2019-17061), Link Layer LLID deadlock (CVE-2019-17060), Sequential ATT Deadlock (CVE-2019-19192), Deadlock from Invalid Connection Request (CVE-2019-19193), Security bypass from Zero LTK Installation (CVE-2019-19194) | [CISA Alert](https://us-cert.cisa.gov/ics/alerts/ics-alert-20-063-01)<br>[PoC Code](https://github.com/Matheus-Garbelini/sweyntooth_bluetooth_low_energy_attacks) |
